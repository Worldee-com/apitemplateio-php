...
class UpdateTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_template_request';
    ...
    */
     ...
     * Sets template_id
     *
     * @param string $template_id Your template id, it can be obtained in the web console(Manage Templates)
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body The HTML body
     *
     * @return self
     */
