...
/**
 * ResponseSuccessTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseSuccessTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseSuccessTemplate';
    ...
    */
     ...
     * Sets body
     *
     * @param string|null $body HTML body of the template
     *
     * @return self
     */
     ...
     * Sets css
     *
     * @param string|null $css CSS of the template
     *
     * @return self
     */
     ...
     * Sets settings
     *
     * @param string|null $settings Print settings of the template
     *
     * @return self
     */
