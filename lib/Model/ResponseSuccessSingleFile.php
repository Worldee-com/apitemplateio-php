...
/**
 * ResponseSuccessSingleFile Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseSuccessSingleFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseSuccessSingleFile';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('primary_url', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['primary_url'];
    }

    /**
     * Sets primary_url
     *
     * @param string|null $primary_url Generated PDF document
     *
     * @return self
     */
    public function setPrimaryUrl($primary_url)
    {
        if (is_null($primary_url)) {
            throw new \InvalidArgumentException('non-nullable primary_url cannot be null');
        }
        $this->container['primary_url'] = $primary_url;
