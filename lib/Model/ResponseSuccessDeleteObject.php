...
/**
 * ResponseSuccessDeleteObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseSuccessDeleteObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseSuccessDeleteObject';
    ...
    */
     ...
     *
     * @param mixed|null $transaction_ref transaction_ref
     *
     * @return self
     */
    public function setTransactionRef($transaction_ref)
    {
        if (is_null($transaction_ref)) {
            array_push($this->openAPINullablesSetToNull, 'transaction_ref');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transaction_ref', $nullablesSetToNull);
            if ($index !== FALSE) {
